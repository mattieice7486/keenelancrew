...
class Profile{
	 ...
	 */
	  ...
	  */
	  public function getAllProfiles(){
		$this->db->query("SELECT profiles.*, users.username, users.avatar, categories.name FROM topics
							INNER JOIN users
	...
	*/
	 ...
	 * Get Profile By ID
	 */
	public function getProfile($profiles_id){
		$this->db->query("SELECT profiles.*, profiles.avatar, profiles.nickname, profiles.age, profiles.location, profiles.favquote, profiles.favgame, profiles.favfood, profiles.favmovie, profiles.hobbies FROM profiles
